"""
Interact with intelchain's transaction RPC API
"""
...
def get_pending_transactions(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#de6c4a12-fa42-44e8-972f-801bfde1dd18
    """
    method = "itcv2_pendingTransactions"
    try:
...
def get_transaction_error_sink(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#9aedbc22-6262-44b1-8276-cd8ae19fa600
    """
    method = "itcv2_getCurrentTransactionErrorSink"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_pending_staking_transactions(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#de0235e4-f4c9-4a69-b6d2-b77dc1ba7b12
    """
    method = "itcv2_pendingStakingTransactions"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_staking_transaction_error_sink(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#bdd00e0f-2ba0-480e-b996-2ef13f10d75a
    """
    method = "itcv2_getCurrentStakingErrorSink"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_pool_stats(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#7c2b9395-8f5e-4eb5-a687-2f1be683d83e
    """
    method = "itcv2_getPoolStats"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_transaction_by_hash(
    ...
    dict with the following keys
        ...
        gas: :obj:`int` Gas limit in INTELLI
        gasPrice :obj:`int` Gas price in INTELLI
        ...
        value: :obj:`int` Amount transferred in INTELLI
    ...
    API Reference
    -------------
    https://api.intelchain.org/#117e84f6-a0ec-444e-abe0-455701310389
    """
    method = "itcv2_getTransactionByHash"
    params = [ tx_hash ]
    try:
        return rpc_request(
            method,
...
def get_transaction_by_block_hash_and_index(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#7c7e8d90-4984-4ebe-bb7e-d7adec167503
    """
    method = "itcv2_getTransactionByBlockHashAndIndex"
...
def get_transaction_by_block_number_and_index(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#bcde8b1c-6ab9-4950-9835-3c7564e49c3e
    """
    method = "itcv2_getTransactionByBlockNumberAndIndex"
...
def get_transaction_receipt(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#0c2799f8-bcdc-41a4-b362-c3a6a763bb5e
    """
    method = "itcv2_getTransactionReceipt"
    params = [ tx_hash ]
    try:
        return rpc_request(
            method,
...
def send_raw_transaction(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#f40d124a-b897-4b7c-baf3-e0dedf8f40a0
    """
    params = [ signed_tx ]
    method = "itcv2_sendRawTransaction"
    try:
        return rpc_request(
            method,
            params = params,
...
def get_pending_cx_receipts(
    ...
    list of CX receipts, each a dict with the following keys
        ...
        receipts: :obj:`list` list of dictionaries, each a cross shard transaction receipt
            amount: :obj:`int` Amount in INTELLI
    ...
    API Reference
    -------------
    https://api.intelchain.org/#fe60070d-97b4-458d-9365-490b44c18851
    """
    method = "itcv2_getPendingCXReceipts"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_cx_receipt_by_hash(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#3d6ad045-800d-4021-aeb5-30a0fbf724fe
    """
    params = [ cx_hash ]
    method = "itcv2_getCXReceiptByHash"
    try:
        return rpc_request(
            method,
            params = params,
...
def resend_cx_receipt(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#c658b56b-d20b-480d-b71a-b0bc505d2164
    """
    method = "itcv2_resendCx"
    params = [ cx_hash ]
    try:
        return rpc_request(
            method,
...
def get_staking_transaction_by_hash(
    ...
    dict with the following keys
        ...
        gasPrice: :obj:`int` Gas price of transaction in INTELLI
        hash: :obj:`str` Transaction hash
    ...
    API Reference
    -------------
    https://api.intelchain.org/#296cb4d0-bce2-48e3-bab9-64c3734edd27
    """
    method = "itcv2_getStakingTransactionByHash"
    params = [ tx_hash ]
    try:
        return rpc_request(
            method,
...
def get_staking_transaction_by_block_hash_and_index(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#ba96cf61-61fe-464a-aa06-2803bb4b358f
    """
    method = "itcv2_getStakingTransactionByBlockHashAndIndex"
    params = [ block_hash, tx_index ]
    try:
        return rpc_request(
            method,
...
def get_staking_transaction_by_block_number_and_index(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#fb41d717-1645-4d3e-8071-6ce8e1b65dd3
    """
    method = "itcv2_getStakingTransactionByBlockNumberAndIndex"
    params = [ block_num, tx_index ]
    try:
        return rpc_request(
            method,
...
def send_raw_staking_transaction(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#e8c17fe9-e730-4c38-95b3-6f1a5b1b9401
    """
    method = "itcv2_sendRawStakingTransaction"
    params = [ raw_tx ]
    try:
        return rpc_request(
            method,
