"""
SignIntelchainstaking transactions
"""
...
from .util import convert_itc_to_hex


# https://github.com/zennittians/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/intelchain-staking/src/stakingTransaction.ts#L335
...
def _sign_transaction_generic(
    ...
    # serialize it
    # https://github.com/zennittians/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/intelchain-staking/src/stakingTransaction.ts#L207
...
def _sign_create_validator( transaction_dict, private_key ):
    ...
    sanitized_transaction[ "stakeMsg" ] = apply_formatters_to_sequence(
        ...
        [
            convert_itc_to_hex( sanitized_transaction.pop( "validatorAddress" ) ),
            description,
            commission,
            math.floor(
...
def sign_staking_transaction( transaction_dict, private_key ):
    ...
    transaction_dict: :obj:`dict`, a dictionary with the following keys
        ...
        Delegate/Undelegate:
            ...
            amount: :obj:`int`, Amount to ( un )delegate in INTELLI
        CreateValidator:
            validatorAddress: :obj:`str`, Address of the validator
    ...
    API Reference
    -------------
    https://github.com/zennittians/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/intelchain-staking/src/stakingTransaction.ts
    """
    assert isinstance(
