...
def get_all_validator_addresses(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#69b93657-8d3c-4d20-9c9f-e51f08c9b3f5
    """
    method = "itcv2_getAllValidatorAddresses"
    try:
...
def get_validator_information(
    ...
    :obj:`dict` Dictionary with the following keys
        validator: :obj:`dict` Dictionary with the following keys
            ...
            min-self-delegation: :obj:`int` Amount that validator must delegate to self in INTELLI
            max-total-delegation: :obj:`int`
                Total amount that validator will aceept delegations until, in INTELLI
    ...
    API Reference
    -------------
    https://api.intelchain.org/#659ad999-14ca-4498-8f74-08ed347cab49
    """
    method = "itcv2_getValidatorInformation"
...
def get_elected_validator_addresses(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#e90a6131-d67c-4110-96ef-b283d452632d
    """
    method = "itcv2_getElectedValidatorAddresses"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_validators(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L152
    """
...
def get_validator_information_by_block_number(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L319
    """
    method = "itcv2_getValidatorInformationByBlockNumber"
...
def get_all_validator_information(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#df5f1631-7397-48e8-87b4-8dd873235b9c
    """
    method = "itcv2_getAllValidatorInformation"
    params = [ page ]
    try:
        return rpc_request(
            method,
...
def get_validator_self_delegation(
    ...
    Returns
    -------
    int, validator stake in INTELLI
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L352
    """
    method = "itcv2_getValidatorSelfDelegation"
    params = [ address ]
    try:
        return int(
            rpc_request(
...
def get_validator_total_delegation(
    ...
    Returns
    -------
    int, total validator stake in INTELLI
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L379
    """
    method = "itcv2_getValidatorTotalDelegation"
    params = [ address ]
    try:
        return int(
            rpc_request(
...
def get_all_validator_information_by_block_number(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#a229253f-ca76-4b9d-88f5-9fd96e40d583
    """
    method = "itcv2_getAllValidatorInformationByBlockNumber"
...
def get_all_delegation_information(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L413
    """
    method = "itcv2_getAllDelegationInformation"
    params = [ page, ]
    try:
        return rpc_request(
            method,
...
def get_delegations_by_delegator(
    ...
    :obj:`list` List of delegations, each a dict with the following keys
        ...
        amount: :obj:`int` Amount delegated in INTELLI
        reward: :obj:`int` Unclaimed rewards in INTELLI
        Undelegations: :obj:`dict` List of pending undelegations, each a dict
            Amount: :obj:`int` Amount to be undelegated in INTELLI
    ...
    API Reference
    -------------
    https://api.intelchain.org/#454b032c-6072-4ecb-bf24-38b3d6d2af69
    """
    method = "itcv2_getDelegationsByDelegator"
...
def get_delegations_by_delegator_by_block_number(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#8ce13bda-e768-47b9-9dbe-193aba410b0a
    """
    method = "itcv2_getDelegationsByDelegatorByBlockNumber"
...
def get_delegation_by_delegator_and_validator(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L605
    """
    method = "itcv2_getDelegationByDelegatorAndValidator"
...
def get_available_redelegation_balance(
    ...
    Returns
    -------
    int, representing the amount of locked undelegated tokens in INTELLI
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L653
    """
    method = "itcv2_getAvailableRedelegationBalance"
    params = [ delegator_addr ]
    try:
        return int(
            rpc_request(
...
def get_delegations_by_validator(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#2e02d8db-8fec-41d9-a672-2c9862f63f39
    """
    method = "itcv2_getDelegationsByValidator"
    params = [ validator_addr ]
    try:
        return rpc_request(
            method,
...
def get_current_utility_metrics(
    ...
    :obj: `dict` with the following keys:
        AccumulatorSnapshot: :obj:`int` Total block reward given out in INTELLI
    ...
    API Reference
    -------------
    https://api.intelchain.org/#78dd2d94-9ff1-4e0c-bbac-b4eec1cdf10b
    """
    method = "itcv2_getCurrentUtilityMetrics"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_staking_network_info(
    ...
    :obj: `dict` with the following keys
        ...
        total-staking: :obj:`int` Total amount staked in INTELLI
        median-raw-stake: :obj:`int` Effective median stake in INTELLI
    ...
    API Reference
    -------------
    https://api.intelchain.org/#4a10fce0-2aa4-4583-bdcb-81ee0800993b
    """
    method = "itcv2_getStakingNetworkInfo"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_super_committees(
        ...
        quorum-deciders: :obj:`dict` dictionary with keys
            shard-X: :obj:`dict` Shard of committees, with the following keys
                committee-members: :obj:`list` List of committee members
                    ...
                    is-intelchain-slot: :obj:`bool` if slot isIntelchainowned
                ...
                itc-voting-power: :obj:`str` Voting power ofIntelchainin percent
            ...
            is-intelchain-slot - Boolean : If slot isIntelchainowned
    ...
    API Reference
    -------------
    https://api.intelchain.org/#8eef2fc4-92db-4610-a9cd-f7b75cfbd080
    """
    method = "itcv2_getSuperCommittees"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
...
def get_total_staking(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/staking.go#L102
    """
    method = "itcv2_getTotalStaking"
    try:
        return int(
            rpc_request( method,
                         endpoint = endpoint,
...
def get_raw_median_stake_snapshot(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#bef93b3f-6763-4121-9c17-f0b0d9e5cc40
    """
    method = "itcv2_getMedianRawStakeSnapshot"
    try:
        return rpc_request( method,
                            endpoint = endpoint,
                            timeout = timeout )[ "result" ]
