"""
Interact with accounts on the intelchain blockchain
"""
...
def get_balance(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#da8901d2-d237-4c3b-9d7d-10af9def05c4
    """
    method = "itcv2_getBalance"
    params = [ address ]
    try:
        balance = rpc_request(
            method,
...
def get_balance_by_block(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#9aeae4b8-1a09-4ed2-956b-d7c96266dd33
    https://github.com/zennittians/intelchain/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/rpc/blockchain.go#L92
    """
    method = "itcv2_getBalanceByBlockNumber"
...
def get_account_nonce(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/rpc/transaction.go#L51
    """
    method = "itcv2_getAccountNonce"
    params = [ address, block_num ]
    try:
        nonce = rpc_request(
            method,
...
def get_transaction_count(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/rpc/transaction.go#L69
    """
    method = "itcv2_getTransactionCount"
    params = [ address, block_num ]
    try:
        nonce = rpc_request(
            method,
...
def get_transactions_count(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#fc97aed2-e65e-4cf4-bc01-8dadb76732c0
    https://github.com/zennittians/intelchain/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/rpc/transaction.go#L114
    """
    method = "itcv2_getTransactionsCount"
...
def get_staking_transactions_count(
    ...
    API Reference
    -------------
    https://api.intelchain.org/#ddc1b029-f341-4c4d-ba19-74b528d6e5e5
    https://github.com/zennittians/intelchain/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/rpc/transaction.go#L134
    """
    method = "itcv2_getStakingTransactionsCount"
    params = [ address, tx_type ]
    try:
        tx_count = rpc_request(
            method,
...
def get_transaction_history( # pylint: disable=too-many-arguments
    ...
    API Reference
    -------------
    https://api.intelchain.org/#2200a088-81b5-4420-a291-312a7c6d880e
    https://github.com/zennittians/intelchain/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/rpc/transaction.go#L255
    """
    params = [
        {
            "address": address,
    ...
    method = "itcv2_getTransactionsHistory"
    try:
...
def get_staking_transaction_history( # pylint: disable=too-many-arguments
    ...
    API Reference
    -------------
    https://api.intelchain.org/#c5d25b36-57be-4e43-a23b-17ace350e322
    https://github.com/zennittians/intelchain/blob/9f320436ff30d9babd957bc5f2e15a1818c86584/rpc/transaction.go#L303
    """
    params = [
        {
            "address": address,
    ...
    method = "itcv2_getStakingTransactionsHistory"
    try:
...
def get_balance_on_all_shards(
    ...
    Returns
    -------
    list of dictionaries, each dictionary to contain shard number and balance of that shard in INTELLI
        Example reply:
        [
            {
                'shard': 0,
...
def get_total_balance(
    ...
    -------
    int
        Total account balance in INTELLI
