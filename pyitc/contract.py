"""
Basic smart contract functions on Intelchain
...
def call( # pylint: disable=too-many-arguments
    ...
    API Reference
    -------------
    https://api.intelchain.org/?version=latest#d34b1f82-9b29-4b68-bac7-52fa0a8884b1
    """
    params = [
        {
            "to": to_address,
...
def estimate_gas( # pylint: disable=too-many-arguments
    ...
    API Reference
    -------------
    https://api.intelchain.org/?version=latest#b9bbfe71-8127-4dda-b26c-ff95c4c22abd
    """
    params = [
        {
            "to": to_address,
...
def get_code(
    ...
    API Reference
    -------------
    https://api.intelchain.org/?version=latest#e13e9d78-9322-4dc8-8917-f2e721a8e556
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/contract.go#L59
    """
    params = [ address, block_num ]
    method = "itcv2_getCode"
    try:
        return rpc_request(
            method,
            params = params,
...
def get_storage_at(
    ...
    API Reference
    -------------
    https://api.intelchain.org/?version=latest#fa8ac8bd-952d-4149-968c-857ca76da43f
    https://github.com/zennittians/intelchain/blob/1a8494c069dc3f708fdf690456713a2411465199/rpc/contract.go#L84
    """
    params = [ address, key, block_num ]
    method = "itcv2_getStorageAt"
    try:
        return rpc_request(
            method,
            params = params,
...
def get_contract_address_from_hash(
    ...
    API Reference
    -------------
    https://github.com/zennittians/intelchain-test/blob/master/localnet/rpc_tests/test_contract.py#L36
    """
    try:
