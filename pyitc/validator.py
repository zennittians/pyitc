"""
Load validator information fromIntelchainblockchain
...
class Validator:  # pylint: disable=too-many-instance-attributes, too-many-public-methods
   ...
   Intelchainvalidator
    ...
    def set_min_self_delegation( self, delegation ):
        ...
        ----------
        delegation: int
            Minimum self delegation of validator in INTELLI
        ...
        if delegation < MIN_REQUIRED_DELEGATION:
            raise InvalidValidatorError(
                3,
                f"Min self delegation must be greater than {MIN_REQUIRED_DELEGATION} INTELLI",
            )
    ...
    def get_min_self_delegation( self ) -> Decimal:
        ...
        -------
        Decimal
            Validator min self delegation in INTELLI
        """
    ...
    def set_max_total_delegation( self, max_delegation ):
        ...
        ----------
        max_delegation: int
            Maximum total delegation of validator in INTELLI
    ...
    def get_max_total_delegation( self ) -> Decimal:
        ...
        -------
        Decimal
            Validator max total delegation in INTELLI
        """
    ...
    def set_amount( self, amount ):
        ...
        ----------
        amount: str
            Initial delegation amount of validator in INTELLI
    ...
    def get_amount( self ) -> Decimal:
        ...
        -------
        Decimal
            Intended initial delegation amount in INTELLI
        """
    ...
    def sign_create_validator_transaction( # pylint: disable=too-many-arguments
        ...
        API Reference
        -------------
        https://github.com/zennittians/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/intelchain-staking/src/stakingTransaction.ts#L413
        """
    ...
    def sign_edit_validator_transaction( # pylint: disable=too-many-arguments
        ...
        API Reference
        -------------
        https://github.com/zennittians/sdk/blob/99a827782fabcd5f91f025af0d8de228956d42b4/packages/intelchain-staking/src/stakingTransaction.ts#L460
        """
        self.set_rate( rate )
