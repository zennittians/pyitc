...
TEMP_DIR = "/tmp/pyitc-testing/test-util"
...
def test_chain_id_to_int():
    ...
    assert util.chain_id_to_int( "itcMainnet" ) == 1
...
def test_convert_itc_to_hex():
    assert (
        util.convert_itc_to_hex( "0xebcd16e8c1d8f493ba04e99a56474122d81a9c58" )
        == "0xeBCD16e8c1D8f493bA04E99a56474122D81A9c58"
    )
    assert (
        util.convert_itc_to_hex( "one1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9" )
        == "0xeBCD16e8c1D8f493bA04E99a56474122D81A9c58"
    )


def test_convert_hex_to_itc():
    assert (
        util.convert_hex_to_itc( "0xebcd16e8c1d8f493ba04e99a56474122d81a9c58" )
        == "one1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9"
    )
    assert (
        util.convert_hex_to_itc( "one1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9" )
        == "one1a0x3d6xpmr6f8wsyaxd9v36pytvp48zckswvv9"
    )
