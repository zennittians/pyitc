...
import { Transaction, RLPSign, TxStatus } from '@intelchain-js/transaction';
...
let itcMessenger = new Messenger(provider, ChainType.Ethereum, ChainID.Default);
...
const provider = new HttpProvider('http://localhost:9500');
let privateKey = '4edef2c24995d15b0e25cbd152fb0e2c05d3b79b9c2afd134e6f59f91bf99e48'
let itcMessenger = new Messenger(provider, ChainType.intelchain, ChainID.itcMainnet);
...
def test_itc_eth_compatible_transaction():
    transaction_dict = {
        "chainId": 1666600000,
        "gas": 21000,
