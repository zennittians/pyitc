...
from pyitc import validator

from pyitc.numbers import convert_itc_to_intelli

from pyitc.exceptions import InvalidValidatorError
...
---
const description: Description = new Description('Alice', 'alice', 'alice.intelchain.org', 'Bob', "Don't mess with me!!!")
...
import {
  ...
  Decimal,
  StakingTransaction,
} from '@intelchain-js/staking'
const { numberToHex, Unit } = require('@intelchain-js/utils');
...
def test_validator_getters( setup_blockchain ):
    ...
    assert test_validator_object.get_website() == "alice.intelchain.org"
