...
def _check_connection():
    try:
        ...
        if "error" in metadata:
            pytest.skip(
                f"Error in itcv2_getNodeMetadata reply: {metadata['error']}",
                allow_module_level = True,
            )
        if "chain-config" not in metadata[ "result" ]:
            pytest.skip(
                "Chain config not found in itcv2_getNodeMetadata reply",
                allow_module_level = True,
            )
        return metadata
    except Exception as e:
        pytest.skip(
            "Can not connect to local blockchain or bad itcv2_getNodeMetadata reply",
            allow_module_level = True,
        )
...
def _check_staking_epoch( metadata ):
    ...
    try:
        ...
        if "error" in latest_header:
            pytest.skip(
                f"Error in itcv2_latestHeader reply: {latest_header['error']}",
                allow_module_level = True,
            )
    except Exception as e:
        pytest.skip(
            "Failed to get itcv2_latestHeader reply",
            allow_module_level = True
        )
...
def _send_transaction( raw_tx, endpoint ):
    try:
        ...
        if "error" in tx:
            pytest.skip(
                f"Error in itcv2_sendRawTransaction reply: {tx['error']}",
                allow_module_level = True,
            )
    except Exception as e:
        pytest.skip(
            "Failed to get itcv2_sendRawTransaction reply",
            allow_module_level = True
        )
...
def _check_transaction( tx_hash, endpoint ):
    try:
        ...
        pytest.skip(
            "Failed to get itcv2_getTransactionByHash reply",
            allow_module_level = True
        )
...
def _send_staking_transaction( raw_tx, endpoint = endpoint ):
    try:
        ...
        if "error" in staking_tx:
            pytest.skip(
                f"Error in itcv2_sendRawStakingTransaction reply: {staking_tx['error']}",
                allow_module_level = True,
            )
    except Exception as e:
        pytest.skip(
            "Failed to get itcv2_sendRawStakingTransaction reply",
            allow_module_level = True,
        )
...
def _check_staking_transaction( stx_hash, endpoint = endpoint ):
    try:
        ...
        pytest.skip(
            "Failed to get itcv2_getStakingTransactionByHash reply",
            allow_module_level = True,
        )
